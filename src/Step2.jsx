        ...
        <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl max-w-2xl w-full p-10 md:p-14 border-2 border-accent-200 animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button 
              ...
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-primary-700 to-primary-900 text-black font-bold px-8 py-4 rounded-xl hover:from-primary-800 hover:to-primary-950 transition-all shadow-lg hover:shadow-xl"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
